...
<head>
    ...
    <title>Accueil — Zoo Encyclopedie</title>
            ...
            <div class="flex flex-col gap-2">
                <div class="flex items-center gap-3 px-1 py-2">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-base font-semibold">Zoo Encyclopedie</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Application éducatif</p>
                    </div>
                </div>
